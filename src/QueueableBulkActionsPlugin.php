...
class QueueableBulkActionsPlugin implements Plugin
{
    ...
    public function getBulkActionRecordTable(): string|null
    {
    ...
    public function getBulkActionModel(): string|null
    {
    ...
    public function getBulkActionRecordModel(): string|null
    {
    ...
    public function getRenderHook(): string|null
    {
    ...
    public function getPollingInterval(): string|null
    {
    ...
    public function getQueueConnection(): string|null
    {
